...
const AREAS: KA[] = [
  ...
  },
  {
    ...
    status: "Implemented",
    module: "/governance",
    evidence: "Tokenization & masking evidence",
  ...
  },
  {
    ...
    status: "Implemented",
    module: "/lineage",
    evidence: "Pipeline maps, contracts",
  ...
  },
  {
    ...
    status: "Partial",
    module: "/catalog",
    evidence: "Limited content registry",
    risk: "Unstructured PII sprawl",
    next: "Inventory unstructured stores",
    owner: "CDO Office",
    steward: "—",
    reviewed: "2026-03-18",
  },
  ...
  },
  {
    ...
    status: "Implemented",
    module: "/projects",
    evidence: "Warehouse models, BI usage",
  ...
  },
  {
    ...
    status: "Partial",
    module: "/catalog",
    evidence: "Catalog beta, lineage graph",
  ...
  },
  {
    ...
    evidence: "Ethics charter draft",
    risk: "No formal AI ethics review",
    next: "Stand up ethics review board",
    owner: "CDO Office",
    steward: "—",
    reviewed: "2026-02-09",
  },
  {
    area: "Data Management Maturity",
    maturity: 3,
    status: "Partial",
    module: "/dama",
    evidence: "DAMA assessment v1",
    risk: "Maturity gaps in 4 areas",
    next: "Quarterly DCAM scoring",
    owner: "CDO Office",
    steward: "G. Patel",
    reviewed: "2026-05-12",
  },
  {
    area: "AI & Big Data Governance",
    maturity: 3,
    status: "Partial",
    module: "/ai-governance",
    evidence: "Model registry, monitoring",
